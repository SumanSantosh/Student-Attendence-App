...
import { StyleSheet, Dimensions, PanResponder, View, Text ,Image } from 'react-native';
    ...
    return (
      <View style={styles.container}>
        <View
          ...
          <Image style={styles.logo} source={require('../assets/Calcilogo.png')} />
          <Text style={styles.titleText}> Calculator </Text>
        </View>

        <View style={{justifyContent: "flex-end"}} {...this.panResponder.panHandlers}>
